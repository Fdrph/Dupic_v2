...
This is a complete rewrite in C++, using Clay for the UI layout and SDL3 for the 2D renderer and cross platform stuff. 
Libvips is used for image manipulation and loading.
